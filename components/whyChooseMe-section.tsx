  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="bg-gradient-to-br from-sage-green/5 to-honey-gold/5 rounded-3xl p-8 md:p-12">
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="text-2xl md:text-3xl font-title font-bold text-sage-green mb-6">
              ¿Por qué{" "}
              <span className="font-script text-honey-gold">elegirme</span> a
              mí?
            </h3>
            <p className="text-lg text-deep-green/80 leading-relaxed font-body mb-10 text-pretty">
              ...
              contenido real, inspiro rutinas que nutren el cuerpo, la mente y
              el planeta.
            </p>

            <div className="grid md:grid-cols-3 gap-8 justify-items-center text-left">
